...
//GenerateTokens returns the access a claim and a access_token string
...
//GenerateRefreshClaims returns return_token
func GenerateRefreshClaims(cl *models.Claims) string {
	...
	//checking the number of refresh tokens closed.
	//if the number of higher than 3, remove  all he refresh tokens and leave only new one.
...
//SecureAuth returns a middlewarewhich secures all the private routes
